...
public abstract class AbstractTransport implements Transport {
	...
	@Override
	public <T extends ClientConnection> T getClientConnection(String clientId,
			...
			try {
				...
				T newClient = clazz
						.getDeclaredConstructor(String.class, String.class,
								ClientsStorage.class, AbstractRemoteService.class)
						.newInstance(clientId, client.getSessionId(), storage,
								remoteService);
				...
				throw new RuntimeException("Can't create instance of "
						+ clazz.toString() + e.getStackTrace());
			}
		} else
	...
	@Override
	public SocketIOFrame processSocketIOFrame(SocketIOFrame frame,
			ClientConnection client, ClientsStorage storage,

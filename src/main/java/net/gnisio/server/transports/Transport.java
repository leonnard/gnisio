...
public interface Transport {
	 ...
	 */
	void processRequest(ClientsStorage clientsStore, String clientId, HttpRequest req, HttpResponse resp,
	 ...
	 * @return
	 */
	<T extends ClientConnection> T getClientConnection(String clientId, ClientsStorage storage,
	 ...
	 * @return
	 */
	SocketIOFrame processSocketIOFrame(SocketIOFrame frame, ClientConnection client, ClientsStorage storage,
